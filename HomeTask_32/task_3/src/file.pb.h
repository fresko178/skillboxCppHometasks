...
class Record final :
 ...
 public:
  ...
  enum : int {
    ...
    kNameFieldNumber = 3,
    kTypeDoFieldNumber = 4,
    kYearFieldNumber = 1,
    kEconomFieldNumber = 5,
  };
  ...
  // optional string type_do = 4;
  bool has_type_do() const;
  private:
  bool _internal_has_type_do() const;
  public:
  void clear_type_do();
  const std::string& type_do() const;
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_type_do(ArgT0&& arg0, ArgT... args);
  std::string* mutable_type_do();
  PROTOBUF_NODISCARD std::string* release_type_do();
  void set_allocated_type_do(std::string* type_do);
  private:
  const std::string& _internal_type_do() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_type_do(const std::string& value);
  std::string* _internal_mutable_type_do();
  public:
  ...
  // optional bool econom = 5;
  bool has_econom() const;
  private:
  bool _internal_has_econom() const;
  public:
  void clear_econom();
  bool econom() const;
  void set_econom(bool value);
  private:
  bool _internal_econom() const;
  void _internal_set_econom(bool value);
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr type_do_;
  int32_t year_;
  bool econom_;
...
// optional string type_do = 4;
inline bool Record::_internal_has_type_do() const {
  bool value = (_has_bits_[0] & 0x00000004u) != 0;
  return value;
}
inline bool Record::has_type_do() const {
  return _internal_has_type_do();
}
inline void Record::clear_type_do() {
  type_do_.ClearToEmpty();
  _has_bits_[0] &= ~0x00000004u;
}
inline const std::string& Record::type_do() const {
  // @@protoc_insertion_point(field_get:Record.type_do)
  return _internal_type_do();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Record::set_type_do(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000004u;
 type_do_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:Record.type_do)
}
inline std::string* Record::mutable_type_do() {
  std::string* _s = _internal_mutable_type_do();
  // @@protoc_insertion_point(field_mutable:Record.type_do)
  return _s;
}
inline const std::string& Record::_internal_type_do() const {
  return type_do_.Get();
}
inline void Record::_internal_set_type_do(const std::string& value) {
  _has_bits_[0] |= 0x00000004u;
  type_do_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* Record::_internal_mutable_type_do() {
  _has_bits_[0] |= 0x00000004u;
  return type_do_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* Record::release_type_do() {
  // @@protoc_insertion_point(field_release:Record.type_do)
  if (!_internal_has_type_do()) {
    return nullptr;
  }
  _has_bits_[0] &= ~0x00000004u;
  auto* p = type_do_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (type_do_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
    type_do_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  return p;
}
inline void Record::set_allocated_type_do(std::string* type_do) {
  if (type_do != nullptr) {
    _has_bits_[0] |= 0x00000004u;
  } else {
    _has_bits_[0] &= ~0x00000004u;
  }
  type_do_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), type_do,
      GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (type_do_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
    type_do_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:Record.type_do)
}

// optional bool econom = 5;
inline bool Record::_internal_has_econom() const {
  bool value = (_has_bits_[0] & 0x00000010u) != 0;
  return value;
}
inline bool Record::has_econom() const {
  return _internal_has_econom();
}
inline void Record::clear_econom() {
  econom_ = false;
  _has_bits_[0] &= ~0x00000010u;
}
inline bool Record::_internal_econom() const {
  return econom_;
}
inline bool Record::econom() const {
  // @@protoc_insertion_point(field_get:Record.econom)
  return _internal_econom();
}
inline void Record::_internal_set_econom(bool value) {
  _has_bits_[0] |= 0x00000010u;
  econom_ = value;
}
inline void Record::set_econom(bool value) {
  _internal_set_econom(value);
  // @@protoc_insertion_point(field_set:Record.econom)
}
